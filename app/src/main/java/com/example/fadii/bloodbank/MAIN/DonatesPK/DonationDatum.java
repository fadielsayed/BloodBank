...
public class DonationDatum {
    ...
    @SerializedName("city")
    @Expose
    private DonationCity donationCity;
    ...
    public DonationCity getCity() {
        return donationCity;
    }

    public void setCity(DonationCity city) {
        this.donationCity = city;
    }

    public DonationClient getClient() {
        return donationClient;
    }

    public void setClient(DonationClient client) {
        this.donationClient = client;
    }
