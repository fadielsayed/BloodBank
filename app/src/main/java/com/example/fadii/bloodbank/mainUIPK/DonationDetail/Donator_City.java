...
public class Donator_City {
    ...
    @Expose
    private Donator_Gouvernet governorate;
    ...
    public Donator_Gouvernet getGovernorate() {
        return governorate;
    }

    public void setGovernorate(Donator_Gouvernet governorate) {
