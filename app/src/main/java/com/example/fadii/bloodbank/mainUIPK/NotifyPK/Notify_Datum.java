...
public class Notify_Datum {
    ...
    @Expose
    private Notify_client notify_client;
    ...
    public Notify_client getPivot() {
        return notify_client;
    }

    public void setPivot(Notify_client pivot) {
        this.notify_client = pivot;
    }
}
